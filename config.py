...
config = {
    ...
    "download_func": get_images,
    "refresh_images": False,
    "evict_images": True,
    "evict_frequency": 3.0,
    "evict_threshold": 6,
    "max_evict": 2,
    "evict_func": get_images,
    "download_dir": "images/",
    "data_dir": "data/",
    "group_dir": "group/",
    "state_dir": "state/",
    ...
    "extra_about_fields": [
        ...
        {
            "name": "Attribution",
            "value": "Images used by this bot are the copyright of their respective owners. These images are sourced from [iDigBio](https://www.idigbio.org/).",
        },
    ],
    "id_groups": True,
    "category_name": "taxon",
